...
public class BookingController implements Serializable {
	...
	public void bookingAtt() {
		...
		case 3:
			...
			break;
		case 4:
			System.out.println("선택하신 놀이기구는 롤러코스터입니다. 현재 롤러코스터의 혼잡도는 복잡입니다. 예약이 불가능합니다.");
	...
	public void bookingTime() { //운행시간에 맞게 예약시간 제한기능 넣기
	...
	public void bookingCheck() {
		...
		try {
			...
			// new FileInputStream("booking" + bnum + "txt").close();
